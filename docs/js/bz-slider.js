(function() {
    ...
    bzSlider.prototype.init = function() {
        let SL = this;
        SL.slider = document.getElementById(SL.selector);
        ...
        SL.slideWidth = parseInt(SL.getElemStyle(SL.sliders[0], 'width'));
        SL.slideHeight = parseInt(SL.getElemStyle(SL.sliders[0], 'height'));
        SL.sliderUlWidth = SL.slideCount * SL.slideWidth;

        SL.slider.style.width = SL.slideWidth + 'px';
        SL.slider.style.height = SL.slideHeight + 'px';

        SL.sliderUl.style.width = SL.sliderUlWidth + 'px';
        SL.sliderUl.style.height = SL.slideHeight + 'px';
        SL.sliderUl.style.marginLeft = -SL.slideWidth + 'px';

        SL.sliderUl.insertBefore(SL.sliders[SL.sliders.length - 1], SL.sliders[0]);

        SL.prevBtn = SL.slider.getElementsByClassName('control-prev')[0];
        SL.nextBtn = SL.slider.getElementsByClassName('control-next')[0];
